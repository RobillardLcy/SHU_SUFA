<<<<<<< HEAD
# Generated by Django 2.0.2 on 2018-02-14 19:21
=======
...
<<<<<<< HEAD
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('info', '个人'), ('warning', '部门'), ('error', '社团')], max_length=7, verbose_name='类别')),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='admins.Admins', verbose_name='所属用户')),
            ],
            options={
                'verbose_name': '管理平台通知',
                'verbose_name_plural': '管理平台通知',
