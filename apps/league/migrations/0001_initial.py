...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='sub',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sub', to='league.TeamMember', verbose_name='替换队员'),
        ),
        migrations.AddField(
            model_name='matchdata',
            name='team_member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='teammate', to='league.TeamMember', verbose_name='队员'),
        ),
        migrations.AddField(
            model_name='match',
            name='away_team',
