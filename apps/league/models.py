...
class LeagueTeamSignup(models.Model):
    """
    队伍赛事报名情况
    用于开通队内报名通道
    """
    id = models.AutoField(primary_key=True, verbose_name='编号')
    league = models.ForeignKey(League, on_delete=models.CASCADE, verbose_name='赛事')
    team = models.ForeignKey(Team, on_delete=models.CASCADE, verbose_name='队伍')
    # -1：待审核
    #  0：审核通过（报名成功）
...
class LeagueTeamMemberSignup(models.Model):
    """
    赛事队内报名情况
    队内报名记录
    """
...
class Match(models.Model):
    ...
    id = models.AutoField(auto_created=True, primary_key=True, verbose_name='编号')
    league = models.ForeignKey(League, on_delete=models.CASCADE, verbose_name='赛事')
    home_team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='home', verbose_name='主队')
    away_team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='away', verbose_name='客队')
    ...
    master_referee = models.ForeignKey(Referee, on_delete=models.SET_NULL, null=True,
                                       related_name='master', verbose_name='主裁')
    second_referee = models.ForeignKey(Referee, on_delete=models.SET_NULL, null=True,
                                       related_name='second', verbose_name='第二助理裁判')
    third_referee = models.ForeignKey(Referee, on_delete=models.SET_NULL, null=True,
                                      related_name='third', verbose_name='第三助理裁判')
    fourth_referee = models.ForeignKey(Referee, on_delete=models.SET_NULL, null=True,
                                       related_name='forth', verbose_name='第四助理裁判')
...
class MatchData(models.Model):
    ...
    team_member = models.ForeignKey(LeagueTeamMemberSignup, on_delete=models.PROTECT,
                                    related_name='teammate', verbose_name='队员')
