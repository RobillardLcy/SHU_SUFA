...
from .views import (CollegeTeamListAPI, CollegeTeamProfileAPI, CollegeTeamCaptainChangeAPI,
                    ...
                    FreeTeamCaptainChangeAPI, LeagueAllListAPI, LeagueRecentListAPI, LeagueProfileAPI,
...
urlpatterns = [
    ...
    # 近期赛事列表(GET)
    path('league/list/recent/', LeagueRecentListAPI.as_view(), name='league-list-recently'),
    # 赛事列表(GET)
