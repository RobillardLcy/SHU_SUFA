    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointment_permission', to='member.Permission', verbose_name='任命所需权限')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.Department', verbose_name='所属部门')),
                ('permission', models.ManyToManyField(related_name='position_permission', through='member.PermissionToPosition', to='member.Permission', verbose_name='职位权限')),
            ],
            options={
                'verbose_name': '职位',
        ...
        migrations.AddField(
            model_name='administratorapply',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='社团成员'),
        ),
        migrations.AddField(
            model_name='administratorapply',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.Position', verbose_name='申请职位'),
        ),
