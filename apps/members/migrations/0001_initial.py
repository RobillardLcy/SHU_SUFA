...
<<<<<<< HEAD
                ('id', models.CharField(max_length=8, primary_key=True, serialize=False, verbose_name='证件号')),
                ...
                ('favorite_club', models.CharField(max_length=50, verbose_name='喜爱的球队')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='image/%Y%m', verbose_name='证件照')),
                ('is_admin', models.BooleanField(default=False, verbose_name='是否是社团骨干')),
                ('is_activiting', models.BooleanField(default=False, verbose_name='是否活跃成员')),
=======
