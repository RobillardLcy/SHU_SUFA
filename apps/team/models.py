...
class ManTeamMember(models.Model):
    """
    男子足球队队员信息
    """
...
class WomanTeamMember(models.Model):
    """
    女子足球队队员信息
    """
    member = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, primary_key=True, verbose_name='成员')
...
class ManTeamMatch(models.Model):
    """
    男子足球队比赛信息
    """
...
class WomanTeamMatch(models.Model):
    """
    女子足球队比赛信息
    """
    id = models.AutoField(auto_created=True, primary_key=True, verbose_name='编号')
...
class ManTeamMatchData(models.Model):
    ...
    """
    id = models.AutoField(auto_created=True, primary_key=True, verbose_name='编号')
    match = models.ForeignKey(ManTeamMatch, on_delete=models.CASCADE, verbose_name='比赛')
    team_member = models.ForeignKey(ManTeamMember, on_delete=models.PROTECT, related_name='teammate', verbose_name='队员')
...
class WomanTeamMatchData(models.Model):
    ...
    """
    id = models.AutoField(auto_created=True, primary_key=True, verbose_name='编号')
    match = models.ForeignKey(WomanTeamMatch, on_delete=models.CASCADE, verbose_name='比赛')
    team_member = models.ForeignKey(WomanTeamMember, on_delete=models.PROTECT, related_name='teammate', verbose_name='队员')
    category = models.CharField(max_length=6,
                                choices=(
                                    ('debut', '首发'),
                                    ('sub', '换人'),
    ...
    sub = models.ForeignKey(WomanTeamMember, on_delete=models.PROTECT, related_name='sub', null=True, default=None, verbose_name='替换队员')
    time = models.CharField(max_length=3, verbose_name='时间')
    remind = models.CharField(max_length=20, verbose_name='备注')
